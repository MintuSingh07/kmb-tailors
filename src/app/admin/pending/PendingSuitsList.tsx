    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8">
      {initialSuits.map((client) => {
        ...
        return (
          <div
            key={client._id}
            className="bg-white border border-[#E6DFD3] rounded-3xl shadow-sm hover:shadow-xl hover:scale-[1.01] transition-all duration-300 flex flex-col justify-between overflow-hidden group"
          >
            ...
            >
              {/* Card Cover Image */}
              {primaryImage ? (
                <div className="relative h-48 w-full bg-slate-100 select-none border-b border-[#E6DFD3]/40 overflow-hidden">
                  <Image
                    src={primaryImage}
              ...
              <div className="p-6">
                <div className="flex items-start justify-between gap-3 mb-4">
                  <div className="flex-1 min-w-0">
                    <h2 className="text-xl sm:text-2xl font-black text-slate-800 truncate leading-snug group-hover:text-[#9E7D3B] transition-colors">
                      {client.name}
                    </h2>
            ...
            <div className="border-t border-slate-100 px-6 py-4 flex items-center justify-between bg-slate-50/50">
              ...
              <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider select-none opacity-0 group-hover:opacity-100 transition-opacity duration-200">
