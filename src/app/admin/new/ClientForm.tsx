                          ...
                          >
                            ...
                            <div className="absolute top-1 right-1 flex items-center gap-1 z-10">
                              <button
                                ...
                                className="h-6 w-6 rounded-full bg-black/60 text-white flex items-center justify-center hover:bg-black/95 transition-colors focus:outline-none cursor-pointer"
                              >
                                <svg
                                  className="h-4.5 w-4.5"
                                  fill="none"
              ...
              <button
                ...
                onClick={() => {
                  sharePhotoOnWhatsApp({
                    imageUrl: activeLightbox.images[lightboxIndex],
                    phoneNo: contactNo || alternativeNo,
                    clientName: name,
                    title: activeLightbox.title,
                  });
                }}
                className="h-10 px-3.5 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white flex items-center gap-2 transition-all cursor-pointer text-xs sm:text-sm font-extrabold shadow-md active:scale-95"
