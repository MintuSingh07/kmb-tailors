                  ...
                  <div className="grid grid-cols-3 h-72 sm:h-80 lg:h-96 bg-slate-50 border-b border-[#E6DFD3] select-none overflow-hidden relative">
                    ...
                    {fabricImg ? (
                      ...
                      >
                        ...
                        <button
                          type="button"
                          title="Share fabric photo on WhatsApp"
                          onClick={(e) => {
                            e.stopPropagation();
                            sharePhotoOnWhatsApp({
                              imageUrl: fabricImg,
                              phoneNo: profile.contactNo || profile.alternativeNo,
                              clientName: profile.name,
                              title: `${q.category} - Fabric Sample`,
                            });
                          }}
                          className="absolute top-2 right-2 p-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-lg z-10 transition-all hover:scale-110 active:scale-95 cursor-pointer opacity-90 hover:opacity-100"
                        >
                    ...
                    {completedImg ? (
                      ...
                      >
                        ...
                        <button
                          type="button"
                          title="Share outfit photo on WhatsApp"
                          onClick={(e) => {
                            e.stopPropagation();
                            sharePhotoOnWhatsApp({
                              imageUrl: completedImg,
                              phoneNo: profile.contactNo || profile.alternativeNo,
                              clientName: profile.name,
                              title: `${q.category} - Completed Outfit Handover`,
                            });
                          }}
                          className="absolute top-2 right-2 p-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-lg z-10 transition-all hover:scale-110 active:scale-95 cursor-pointer opacity-90 hover:opacity-100"
                        >
                    ...
                    {sketchImg ? (
                      ...
                      >
                        ...
                        <button
                          type="button"
                          title="Share sketch on WhatsApp"
                          onClick={(e) => {
                            e.stopPropagation();
                            sharePhotoOnWhatsApp({
                              imageUrl: sketchImg,
                              phoneNo: profile.contactNo || profile.alternativeNo,
                              clientName: profile.name,
                              title: `${q.category} - Measurement Sketch`,
                            });
                          }}
                          className="absolute top-2 right-2 p-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-lg z-10 transition-all hover:scale-110 active:scale-95 cursor-pointer opacity-90 hover:opacity-100"
                        >
                  ...
                  onClick={() => {
                    if (selectedImage) {
                      sharePhotoOnWhatsApp({
                        ...
                        phoneNo: profile.contactNo || profile.alternativeNo,
                        clientName: profile.name,
                        title: `${selectedImageRecord?.category || ''} - ${selectedImageType}`,
                      });
                    }
                  }}
                  className="w-full py-3.5 bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-xs sm:text-sm rounded-2xl transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer active:scale-95"
                >
